...
<meta charset="utf-8">
        ...
        <title>Portal Barrio | Login clientes</title>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="cart-table">
                    <form class="form-sign" action="ClientesValidacion" method="post">
                        <h3 class="text-left">Login<p class="text-right"><a href="clienteregistro.jsp">No tienes cuenta? Crea una</a></p></h3>       
                        
                        <div class="promo-code-form">
                            <h5>Rut</h5>
                            <input type="text" class="form-control" oninput="checkRut(this)" id="rut" name="rut" maxLength="10" placeholder="Ingrese su rut" required="required" name="txtRut">
                        </div>
                        
                        <div class="promo-code-form">
                            <h5>Contraseña</h5>
                            <input type="password" maxLength="10" class="form-control" id="clave" name="clave" placeholder="Ingrese su contraseña" required="required" name="txtClave">
                        </div>
