...
<div class="login-page">
  <div class="form">
     <form action="controladmin?menu=crudusuarioadmin" method="POST" class="login-form">
      <label>Nombres</label>
      ...
      <button type="submit" id="Registrar" name="accion" value="listar_admin" class="btn btn-danger" formnovalidate>Cancelar</button>
