					...
					<div class="cart-table">
						...
						<div class="promo-code-form">
                                                ...
                                                <div class="promo-code-form">
                                                    ...
                                                    <input type="text" maxLength="10" oninput="checkRut(this)" name="rut_almacenero" id="rut_almacenero" required placeholder="Ingrese su rut sin puntos ni guión">
                                                </div>
                                                <div class="promo-code-form">
                                                    <h5>Rut Comercial</h5>
                                                    <!--Caja de texto para ingresar el rut del cliente, con un minimo de 10 caracteres y un maximo de 10, ya que es un RUT y debe ir como tal -->
                                                    <input type="text" maxLength="10" oninput="checkRut(this)" name="rut_comercial" id="rut_comercial" required placeholder="Ingrese el rut sin puntos ni guión">
                                                </div>
