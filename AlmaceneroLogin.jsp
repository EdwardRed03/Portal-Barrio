...
<meta charset="utf-8">
        ...
        <title>Portal Barrio | Login Almacenero</title>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="cart-table">
                    <form class="form-sign" action="AlmaceneroLoginn" method="post">
                        <h3 class="text-left">Login Almacenero<p class="text-right"><a href="clienteregistro.jsp">No tienes cuenta? Crea una</a></p></h3>       
                        
                        <div class="promo-code-form">
                            <h5>Rut Almacenero</h5>
                            <input type="text" class="form-control" oninput="checkRut(this)" id="rut_almacenero" name="rut_almacenero" maxLength="10" placeholder="Ingrese su rut" required="required">
                        </div>
                        
                        <div class="promo-code-form">
                            <h5>Rut Almacen</h5>
                            <input type="text" class="form-control" oninput="checkRut(this)" id="rut_comercial" name="rut_comercial" maxLength="10" placeholder="Ingrese el rut de su almacen" required="required">
                        </div>
